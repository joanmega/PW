            ...
            <div id="cuerpo">
				...
				?>
					...
					<?php
						if (isset($_GET['Video'])){
					?>	
					<video id="reproductor" preload="auto" autoplay="autoplay" controls="controls" poster="../../img/viDocens_logo_WP.png">
						...
						<object>
							<embed src="<?php echo $_GET['../../profesores/material/Video']; ?>" type= "application/x-shockwave-flash" allowfullscreen="false" allowscriptaccess="always" />
					   </object>
					</video>
					<?php	
						}
