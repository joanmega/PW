                    ...
                    <fieldset>
						...
						<?php
							if (isset($_REQUEST['bBuscar'])){
								...
								// Visualizamos todos los alumnos de ese curso
									$sentencia = 'SELECT u.*, u.*, c.Descripcion as "descripcion", c.Nombre as "nombreCurso" 
									FROM usuario u, inscrito i, curso c 
									WHERE i.Cod_Alumno = u.cod_usuario 
