            ...
            <div id="cuerpo">
                ...
                <div id="contenido">
                    <fieldset>
						...
						<?php
							...
							if (isset($_REQUEST['bAceptar']) && $_REQUEST['tDNI']!='' && $_REQUEST['tApellido1']!='' && $_REQUEST['tApellido2']!='' && $_REQUEST['tNombre']!='' && $_REQUEST['DiaNac']!=0 && $_REQUEST['MesNac']!=0 && $_REQUEST['tUsuario']!='' && $_REQUEST['tContrasena']!='' && $_REQUEST['tContrasena2']!=''){
								...
								set pais="'.$pais.'", telefono="'.$telefono.'", movil="'.$movil.'", correoElectronico="'.$correoElectronico.'", fecNacimiento="'.$fecNacimiento.'", domicilio="'.$domicilio.'", usuario="'.$usuario.'", contrasena="'.md5($contrasena).'" 
								where DNI="'.$DNI.'";';
						...
						?>
							<form id="modificarAlumnos" method="post" name="modificarAlumnos" action="modificarAlumno.php">
								<table>
									<tr>
					...
					<?php
									...
									echo "No hay alumnos que modificar. <br>";
								}
						}else{
					?>
						<form id="buscarAlumno" method="post" name="buscarAlumno" action="modificarAlumno.php"> 
                            <table>
                                <tr>
                                    <td><label>Nombre</label></td>
                                    <td>
