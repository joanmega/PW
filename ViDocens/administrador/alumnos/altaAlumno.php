                        ...
                        <form id="anadirAlumnos" method="post" name="anadirAlumnos" action="altaAlumno.php">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input name="tTelefono" type="text" value="0" onblur="validacion(tTelefono);" size="11" maxlength="11" tabindex="6" <?php if(isset($_REQUEST['bAceptar'])) echo 'value="'.$_REQUEST['tTelefono']. '"'; ?>/></td>
                                </tr>
                                <tr>
                                    <td><label>M&oacute;vil</label></td>
                                    <td><input name="tMovil" type="text" size="11" value="0" onblur="validacion(tMovil);" maxlength="11" tabindex="7" <?php if(isset($_REQUEST['bAceptar'])) echo 'value="'.$_REQUEST['tMovil']. '"'; ?>/></td>
                                </tr>
                                <tr>
